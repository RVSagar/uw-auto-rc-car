...
def CIFARBaseModel():
    ...
    model.add(Conv2D(32, (5, 5), activation='elu', kernel_initializer='he_uniform', padding='same'))
    model.add(MaxPooling2D((2, 2)))
    model.add(Dropout(0.2))
    
    model.add(Conv2D(64, (5, 5), activation='elu', kernel_initializer='he_uniform', padding='same'))
    model.add(Conv2D(64, (5, 5), activation='elu', kernel_initializer='he_uniform', padding='same'))
    model.add(MaxPooling2D((2, 2)))
    model.add(Dropout(0.3))
    
    model.add(Conv2D(128, (2, 2), activation='elu', kernel_initializer='he_uniform', padding='same'))
    model.add(Conv2D(128, (2, 2), activation='elu', kernel_initializer='he_uniform', padding='same'))
    model.add(MaxPooling2D((2, 2)))
...
def plot_results(result, y_test, y_pred):
    ...
    #plt.plot(result.history['r_square'],color='blue')
    #plt.plot(result.history['val_r_square'],color='red')
    #plt.title('model R^2')
    #plt.ylabel('R^2')
    #plt.xlabel('epoch')
    ...
    #plt.plot(result.history['rmse'],color='blue')
    #plt.plot(result.history['val_rmse'],color='red')
    #plt.title('rmse')
    #plt.ylabel('rmse')
    #plt.xlabel('epoch')
    #plt.legend(['train', 'test'], loc='upper left')
...
if __name__ == "__main__":
    ...
    package_dir = "C:/Users/Liam/catkin_ws/src/road_dataset_generation"
    ...
    it_train = datagen.flow(X_train, Y_train, batch_size=8)
